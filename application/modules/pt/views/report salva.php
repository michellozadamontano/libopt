    ...
    for($i=1 ; $i<=$day_month;$i++):;?>
        <tr>
            ...
            for($k = $i ; $k<= ($i+6);$k++):
                ...
                <td style="margin: 0px;padding: 0px;vertical-align: top;border: 1px solid black">
                    <?php
                    ...
                    <table style="border: 0px;width: 100%;" cellpadding="0" cellspacing="0">
                        <tr>
                            <th style="border: solid black;text-align: center;margin-top: 0px;background-color: #9e9e9e">
                                <?php
                                ...
                                if(($day_number == 3)&& ($dia == $miercoles)):?>
                                    <span><?php echo utf8_decode("Miércoles"). ' '.$month_count;?></span>
                                    <?php
                                    $month_count++;
                                    $show = true;?>
                                <?php endif?>
                        ...
                        <tr>
                            <td style="border: 0px;padding-bottom: 40px">
                                <?php if($show):?>
                                    <?php echo utf8_decode(Modules::run('pt/get_planpdf',$date)) ;?>
                                <?php endif?>
                            </td>
                        </tr>
                    </table>
